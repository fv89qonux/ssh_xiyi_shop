...
<head>
 ...
 {                                                                                         
	 ...
	 var radiois = document.getElementsByName("usertype");
			  	 var k = 0;
      			 if(radiois[0].checked) 
      			 {k=1;
      			 }
      			 if(radiois[1].checked) 
      			 {k=2;
      			 }
	 if(k == 0)
	 {
	 ...
	 loginService.login(document.ThisForm.userName.value,document.ThisForm.userPw.value,k,callback);
 }
...
<body>
	...
	<table width="559" height="423" border="0" align="center"
		...
		<tr>
			<td>
				<div align="center" style="FONT-WEIGHT: bold;color:white; FONT-SIZE: 40pt;">洗衣店后台管理系统<br>  
						...
						<tr>
							<td height="31" colspan="2" valign="top" class="STYLE15">
								...
								<input name="usertype" type="radio" value="1">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;员工									
								<input name="usertype" type="radio" value="2">
							</td>
						</tr>
						<tr>
							<td height="10" colspan="2" valign="bottom"></td>
