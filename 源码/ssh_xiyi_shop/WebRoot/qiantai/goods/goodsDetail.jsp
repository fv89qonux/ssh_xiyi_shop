		            ...
		            <div class="list pic_news">
						  	...
						  	<form action="<%=path %>/addToCart.action" method="post" name="buy">
                                  <table border="0" cellpadding="6">
                                      ...
                                      <tr><td width="30"></td><td style="font-size: 11px;">照片详情：</td><td style="font-size: 11px;"><img style="width:300px;height:300px" src="<%=request.getContextPath()%><s:property value="#request.goods.goodsPic"/>"></td></tr>
